...
golem::fill_desc(
  pkg_name = "covid19mxMobile", # The Name of the package containing the App 
  pkg_title = "covid19mxMobile", # The Title of the package containing the App 
  pkg_description = "Same app as covid19mx but the app is improved for mobile phones.", # The Description of the package containing the App 
  ...
  repo_url = "https://github.com/alberto-mateos-mo/covid19mxMobile" # The (optional) URL of the GitHub Repo
)     
